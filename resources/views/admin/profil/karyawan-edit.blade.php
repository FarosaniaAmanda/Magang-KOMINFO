        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 border-b border-gray-200">
                ...
                <div class="flex items-start gap-3 sm:gap-4">
                    ...
                    <div class="w-10 h-10 sm:w-11 sm:h-11 shrink-0 rounded-xl bg-[#C9A227] flex items-center justify-center text-white text-sm sm:text-lg">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-xl sm:rounded-2xl p-4 sm:p-5 text-center">
                                ...
                                @else
                                    ...
                                    <p
                                        id="photo-status"
                                        class="hidden text-xs text-gray-500 mb-4"
                                    >
                                        Preview foto baru
                                    </p>
    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
            ...
            if (photoStatus) {
                ...
                photoStatus.textContent = 'Preview foto baru';
